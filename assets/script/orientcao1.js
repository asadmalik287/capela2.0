form_Fields.onsubmit = async (e) => {
    ...
    // let sendTo = "ir.armelinda@thunderbees.com";


    // if (state.toUpperCase() == "SP" || state.toUpperCase() == "MG" || state.toUpperCase() == "RJ" || state.toUpperCase() == "ES" || state.toUpperCase() == "GO" || state.toUpperCase() == "DF" ||
    // state.toUpperCase() == "TO" || state.toUpperCase() == "BA" || state.toUpperCase() == "SE" || state.toUpperCase() == "AL" || state.toUpperCase() == "PE" || state.toUpperCase() == "PB" ||
    // state.toUpperCase() == "RN" || state.toUpperCase() == "CE" || state.toUpperCase() == "PI" || state.toUpperCase() == "MA") {
    // sendTo = "jussps@gmail.com"

    // }
    // if (state.toUpperCase() == "RS" || state.toUpperCase() == "SC" || state.toUpperCase() == "PR" || state.toUpperCase() == "MS" || state.toUpperCase() == "MT" || state.toUpperCase() == "RO" ||
    // state.toUpperCase() == "AC" || state.toUpperCase() == "AM" || state.toUpperCase() == "PA" || state.toUpperCase() == "RR" || state.toUpperCase() == "AP") {
